...
D_Work_str str_DWork;

/* Real-time model */
RT_MODEL_str str_M_;
RT_MODEL_str *str_M = &str_M_;
...
void str_step(void)
{
  ...
  rtb_UnitDelay3 = str_DWork.UnitDelay3_DSTATE;

  /* UnitDelay: '<S2>/Unit Delay6' */
  rtb_UnitDelay6 = str_DWork.UnitDelay6_DSTATE;
  ...
  /* '<S4>:1:3' */
  /* '<S4>:1:4' */
  eml_PHI_idx = -str_DWork.UnitDelay6_DSTATE;
  eml_PHI_idx_0 = -str_DWork.UnitDelay5_DSTATE;

  /* '<S4>:1:5' */
  eml_a[0] = eml_PHI_idx;
  eml_a[1] = eml_PHI_idx_0;
  eml_a[2] = str_DWork.UnitDelay3_DSTATE;
  eml_a[3] = str_DWork.UnitDelay2_DSTATE;
  eml_e = In2 - (((eml_a[0] * str_DWork.UnitDelay_DSTATE[0] + eml_a[1] *
                   str_DWork.UnitDelay_DSTATE[1]) + eml_a[2] *
                  str_DWork.UnitDelay_DSTATE[2]) + eml_a[3] *
                 str_DWork.UnitDelay_DSTATE[3]);

  /* '<S4>:1:6' */
  for (tmp = 0; tmp < 4; tmp++) {
    eml_y = str_DWork.UnitDelay1_DSTATE[(tmp << 2) + 3] *
      str_DWork.UnitDelay2_DSTATE + (str_DWork.UnitDelay1_DSTATE[(tmp << 2) + 2]
      * str_DWork.UnitDelay3_DSTATE + (str_DWork.UnitDelay1_DSTATE[(tmp << 2) +
      1] * eml_PHI_idx_0 + str_DWork.UnitDelay1_DSTATE[(tmp << 2)] * eml_PHI_idx));
    eml_a[tmp] = eml_y;
  }

  eml_B = (((eml_a[0] * eml_PHI_idx + eml_a[1] * eml_PHI_idx_0) + eml_a[2] *
            str_DWork.UnitDelay3_DSTATE) + eml_a[3] *
           str_DWork.UnitDelay2_DSTATE) + 0.95;
  ...
  for (tmp = 0; tmp < 4; tmp++) {
    eml_y = str_DWork.UnitDelay1_DSTATE[(tmp << 2) + 3] *
      ...
      * str_DWork.UnitDelay3_DSTATE + (str_DWork.UnitDelay1_DSTATE[(tmp << 2) +
      1] * eml_PHI_idx_0 + str_DWork.UnitDelay1_DSTATE[(tmp << 2)] * eml_PHI_idx));
    rtb_Theta[tmp] = (((str_DWork.UnitDelay1_DSTATE[tmp + 4] * eml_PHI_idx_0 +
                        str_DWork.UnitDelay1_DSTATE[tmp] * eml_PHI_idx) +
                       str_DWork.UnitDelay1_DSTATE[tmp + 8] *
                       str_DWork.UnitDelay3_DSTATE) +
                      str_DWork.UnitDelay1_DSTATE[tmp + 12] *
                      str_DWork.UnitDelay2_DSTATE) / eml_B * eml_e +
      str_DWork.UnitDelay_DSTATE[tmp];
    rtb_UnitDelay6_p = str_DWork.UnitDelay1_DSTATE[tmp + 12] *
      str_DWork.UnitDelay2_DSTATE + (str_DWork.UnitDelay1_DSTATE[tmp + 8] *
      str_DWork.UnitDelay3_DSTATE + (str_DWork.UnitDelay1_DSTATE[tmp + 4] *
      eml_PHI_idx_0 + str_DWork.UnitDelay1_DSTATE[tmp] * eml_PHI_idx));
    rtb_UnitDelay2_p = str_DWork.UnitDelay1_DSTATE[(tmp << 2) + 3] *
      str_DWork.UnitDelay2_DSTATE + (str_DWork.UnitDelay1_DSTATE[(tmp << 2) + 2]
      * str_DWork.UnitDelay3_DSTATE + (str_DWork.UnitDelay1_DSTATE[(tmp << 2) +
      1] * eml_PHI_idx_0 + str_DWork.UnitDelay1_DSTATE[(tmp << 2)] * eml_PHI_idx));
    eml_PHI[tmp] = rtb_UnitDelay2_p;
    tmp_0[tmp] = rtb_UnitDelay6_p;
    eml_a[tmp] = eml_y;
  }
  ...
  rtb_UnitDelay2_p = str_DWork.UnitDelay2_DSTATE_b;
  ...
  eml_e = ((((eml_e * In1 - (eml_e - ((eml_r + eml_r_0) + eml_r_1) /
    eml_PHI_idx_0) * In2) - ((((eml_r + eml_r_0) + eml_r_1) - eml_r_3) - eml_a_0)
           ...
           str_DWork.UnitDelay2_DSTATE_b) - (-(eml_r_2 / eml_PHI_idx_0)) *
    str_DWork.UnitDelay1_DSTATE_h;

  /* Saturate: '<S3>/Saturation' */
  Out1 = rt_SATURATE(eml_e, str_P.Saturation_LowerSat, str_P.Saturation_UpperSat);

  /* Update for UnitDelay: '<S2>/Unit Delay3' */
  str_DWork.UnitDelay3_DSTATE = Out1;

  /* Update for UnitDelay: '<S2>/Unit Delay2' */
  str_DWork.UnitDelay2_DSTATE = rtb_UnitDelay3;

  /* Update for UnitDelay: '<S2>/Unit Delay6' incorporates:
   *  Update for Inport: '<Root>/Sensor'
   */
  str_DWork.UnitDelay6_DSTATE = In2;

  /* Update for UnitDelay: '<S2>/Unit Delay5' */
  str_DWork.UnitDelay5_DSTATE = rtb_UnitDelay6;

  /* Update for UnitDelay: '<S2>/Unit Delay1' incorporates:
   *  UnitDelay: '<S2>/Unit Delay1'
   */
  for (tmp = 0; tmp < 4; tmp++) {
    tmp_1[tmp] = str_DWork.UnitDelay1_DSTATE[tmp] - tmp_0[tmp] * eml_PHI[0] /
      eml_y;
    tmp_1[tmp + 4] = str_DWork.UnitDelay1_DSTATE[tmp + 4] - tmp_0[tmp] *
      eml_PHI[1] / eml_y;
    tmp_1[tmp + 8] = str_DWork.UnitDelay1_DSTATE[tmp + 8] - tmp_0[tmp] *
      eml_PHI[2] / eml_y;
    tmp_1[tmp + 12] = str_DWork.UnitDelay1_DSTATE[tmp + 12] - tmp_0[tmp] *
      eml_PHI[3] / eml_y;
  }

  for (tmp = 0; tmp < 4; tmp++) {
    str_DWork.UnitDelay1_DSTATE[(tmp << 2)] = tmp_1[tmp << 2] *
      1.0526315789473684E+000;
    str_DWork.UnitDelay1_DSTATE[1 + (tmp << 2)] = tmp_1[(tmp << 2) + 1] *
      1.0526315789473684E+000;
    str_DWork.UnitDelay1_DSTATE[2 + (tmp << 2)] = tmp_1[(tmp << 2) + 2] *
      1.0526315789473684E+000;
    str_DWork.UnitDelay1_DSTATE[3 + (tmp << 2)] = tmp_1[(tmp << 2) + 3] *
      1.0526315789473684E+000;
  }

  /* Update for UnitDelay: '<S2>/Unit Delay' */
  str_DWork.UnitDelay_DSTATE[0] = rtb_Theta[0];
  str_DWork.UnitDelay_DSTATE[1] = rtb_Theta[1];
  str_DWork.UnitDelay_DSTATE[2] = rtb_Theta[2];
  str_DWork.UnitDelay_DSTATE[3] = rtb_Theta[3];

  /* Update for UnitDelay: '<S3>/Unit Delay6' incorporates:
   *  Update for Inport: '<Root>/Sensor'
   */
  str_DWork.UnitDelay6_DSTATE_g = In2;

  /* Update for UnitDelay: '<S3>/Unit Delay5' */
  str_DWork.UnitDelay5_DSTATE_i = rtb_UnitDelay6_p;

  /* Update for UnitDelay: '<S3>/Unit Delay2' */
  str_DWork.UnitDelay2_DSTATE_b = Out1;

  /* Update for UnitDelay: '<S3>/Unit Delay1' */
  str_DWork.UnitDelay1_DSTATE_h = rtb_UnitDelay2_p;
}
...
void str_initialize(void)
{
  ...
  str_DWork.UnitDelay2_DSTATE = str_P.UnitDelay2_X0;

  /* InitializeConditions for UnitDelay: '<S2>/Unit Delay6' */
  str_DWork.UnitDelay6_DSTATE = str_P.UnitDelay6_X0;

  /* InitializeConditions for UnitDelay: '<S2>/Unit Delay5' */
  str_DWork.UnitDelay5_DSTATE = str_P.UnitDelay5_X0;

  /* InitializeConditions for UnitDelay: '<S2>/Unit Delay1' */
  memcpy((void *)(&str_DWork.UnitDelay1_DSTATE[0]), (void *)
         (&str_P.UnitDelay1_X0[0]), sizeof(real_T) << 4U);

  /* InitializeConditions for UnitDelay: '<S2>/Unit Delay' */
  str_DWork.UnitDelay_DSTATE[0] = str_P.UnitDelay_X0[0];
  str_DWork.UnitDelay_DSTATE[1] = str_P.UnitDelay_X0[1];
  str_DWork.UnitDelay_DSTATE[2] = str_P.UnitDelay_X0[2];
  str_DWork.UnitDelay_DSTATE[3] = str_P.UnitDelay_X0[3];

  /* InitializeConditions for UnitDelay: '<S3>/Unit Delay6' */
  str_DWork.UnitDelay6_DSTATE_g = str_P.UnitDelay6_X0_n;

  /* InitializeConditions for UnitDelay: '<S3>/Unit Delay5' */
  str_DWork.UnitDelay5_DSTATE_i = str_P.UnitDelay5_X0_e;

  /* InitializeConditions for UnitDelay: '<S3>/Unit Delay2' */
  str_DWork.UnitDelay2_DSTATE_b = str_P.UnitDelay2_X0_f;

  /* InitializeConditions for UnitDelay: '<S3>/Unit Delay1' */
  str_DWork.UnitDelay1_DSTATE_h = str_P.UnitDelay1_X0_i;
}
